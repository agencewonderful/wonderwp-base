...
export class VideoNativeComponent extends PewComponent {
  init() {
...
window.pew.addRegistryEntry({key: 'video-component', domSelector: '[data-video-component]', classDef: VideoNativeComponent});
